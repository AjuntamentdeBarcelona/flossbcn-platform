 ...
 */
namespace Drupal\security_extension;
use Drupal\security_extension\CrawlerDetect\Headers;
use Drupal\security_extension\CrawlerDetect\Crawlers;
use Drupal\security_extension\CrawlerDetect\Exclusions;
class CrawlerDetect
{
    /**
     * The user agent.
