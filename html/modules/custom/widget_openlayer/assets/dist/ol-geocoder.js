...
! function(e, t) {
    ...
    function S(e, t) {
        ...
        for (; s.childNodes[0];) n.appendChild(s.childNodes[0]);
    ...
    function j(e, t, s) {
        e.classList ? e.classList.add(t) : e.className = (e.className + " " + t).trim(), s && R(s) && window.setTimeout(function() {
            return O(e, t)
        }, s)
    }

    function O(e, t, s) {
        e.classList ? e.classList.remove(t) : e.className = e.className.replace(I(t), " ").trim(), s && R(s) && window.setTimeout(function() {
            return j(e, t)
        }, s)
    }
    const A = u.cssClasses;
    var M = function(e) {
    ...
    M.prototype.createControl = function() {
        ...
        return this.options.targetType === m ? (t = A.namespace + " " + A.inputText.container, s = {
            ...
            control: T("." + A.inputText.control, e),
            input: T("." + A.inputText.input, e),
            reset: T("." + A.inputText.reset, e),
            result: T("." + A.inputText.result, e)
        }) : (t = A.namespace + " " + A.glass.container, s = {
            container: e = S(["div", {
                id: u.containerId,
                classname: t
            }], M.glass),
            control: T("." + A.glass.control, e),
            button: T("." + A.glass.button, e),
            input: T("." + A.glass.input, e),
            reset: T("." + A.glass.reset, e),
            result: T("." + A.glass.result, e)
    ...
    function z(e) {
        return new Promise(function(t, s) {
            const n = function(e, t) {
                    t && "object" == typeof t && (e += (/\?/.test(e) ? "&" : "?") + function e(t) {
                        return Object.keys(t).reduce(function(s, n) {
                            return s.push("object" == typeof t[n] ? e(t[n]) : encodeURIComponent(n) + "=" + encodeURIComponent(t[n])), s
                        }, []).join("&")
                    }(t));
                    return e
                }(e.url, e.data),
    ...
    const U = u.cssClasses;
    var G = function(s, n) {
        this.Base = s, this.layerName = x("geocoder-layer-"), this.layer = new e({
            name: this.layerName,
            source: new t
            ...
            mapClick: !1
        }, this.setListeners(), this.Photon = new _, this.OpenStreet = new B, this.MapQuest = new D, this.Pelias = new Q, this.Bing = new V, this.OpenCage = new F
    };
    return G.prototype.setListeners = function() {
            ...
            this.els.input.addEventListener("keypress", function(t) {
                ...
                const r = n.target.value.trim();
                r.length ? N(e.els.reset, U.hidden) : P(e.els.reset, U.hidden), e.options.autoComplete && r !== s && (s = r, t && clearTimeout(t), t = setTimeout(function() {
                    r.length >= e.options.autoCompleteMinLength && e.query(r)
                }, 200))
            }, !1), this.els.reset.addEventListener("click", function(t) {
                e.els.input.focus(), e.els.input.value = "", e.lastQuery = "", P(e.els.reset, U.hidden), e.clearResults()
            ...
            this.lastQuery = e, this.clearResults(), P(this.els.reset, U.spin);
            let n = {
                url: s.url,
                data: s.params
            };
            s.callbackName && (n.jsonp = !0, n.callbackName = s.callbackName), z(n).then(function(e) {
                ...
                const s = S("li", "<h5>Error! No internet connection?</h5>");
                t.els.result.appendChild(s)
            })
        }, G.prototype.createList = function(e) {
            var t = this;
            const s = this.els.result;
            ...
            if (!1 === this.options.keepOpen && this.clearResults(!0), !0 === this.options.preventDefault) this.Base.dispatchEvent({
                ...
                const e = this.createFeature(l, u);
            ...
            const t = new n(new s(e));
            return this.addLayer(), t.setStyle(this.options.featureStyle), t.setId(x("geocoder-ft-")), this.getSource().addFeature(t), t
            ...
            var e = this;
            N(this.els.input, U.spin), P(this.els.control, U.glass.expanded), window.setTimeout(function() {
                return e.els.input.focus()
            }, 100), this.listenMapClick()
        }, G.prototype.collapse = function() {
            this.els.input.value = "", this.els.input.blur(), P(this.els.reset, U.hidden), N(this.els.control, U.glass.expanded), this.clearResults()
        ...
        function(e) {
            function t(s, n) {
                ...
                let r;
                E("string" == typeof s, "@param `type` should be string!"), E(s === d.NOMINATIM || s === d.REVERSE, "@param 'type' should be '" + d.NOMINATIM + "'\n        or '" + d.REVERSE + "'!"), E("object" == typeof n, "@param `options` should be object!"), C.featureStyle = [new a({
                    /* image: new i({
                        scale: .7,
                        src: g
                    }) */
                ...
                const o = new M(this);
                s === d.NOMINATIM ? (this.container = o.els.container, r = new G(this, o.els), this.layer = r.layer) : d.REVERSE, e.call(this, {
